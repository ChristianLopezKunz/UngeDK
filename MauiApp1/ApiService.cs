...
namespace MauiApp1
{
    ...
    {
        private const string ApiKey = "7F125C9A-36FB-41BB-BBFB-73813D7BE40D";  // Din API-nøgle
        ...
        public async Task<JobDetailApiResponse> GetJobDetailAsync(int jobId)
        {
            try
            {
                ...
                Console.WriteLine($"API Response: {jsonResponse}"); // Debug udskrift

                // Deserialiser JSON-svaret til modellen
